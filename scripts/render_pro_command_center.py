...
def log(msg: str) -> None:
    print(f"[pro-cc-runner] {msg}", flush=True)
...
def scout_loop() -> None:
    ...
    while True:
        ...
        try:
            ...
            import json
            from gold_trader.web.pro_command_center import _latest_decision_path
...
def main() -> None:
    ...
    from gold_trader.web.pro_command_center import serve

    host = os.getenv("HOST", "0.0.0.0")
    port = int(os.getenv("PORT", "8770"))
    log("Professional command center enabled")
