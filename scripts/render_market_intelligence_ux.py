...
def log(msg: str) -> None:
    print(f"[market-ux] {msg}", flush=True)
    ...
    while True:
        ...
        try:
            ...
            try:
                ...
                import json
                from gold_trader.core.market_intelligence_ux import find_decision_path
...
def main() -> None:
    ...
    from gold_trader.web.market_intelligence_api import serve

    host = os.getenv("HOST", "0.0.0.0")
    port = int(os.getenv("PORT", "8770"))
    log(f"market intelligence UX on {host}:{port}")
