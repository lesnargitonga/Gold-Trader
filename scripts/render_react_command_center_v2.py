...
def log(msg: str) -> None:
    print(f"[render-react-v2] {msg}", flush=True)
...
def scout_loop() -> None:
    ...
    delay = int(os.getenv("GOLD_RENDER_SCOUT_STARTUP_DELAY_SECONDS", os.getenv("GOLD_RENDER_SCOUT_INITIAL_DELAY_SECONDS", "6")))
...
def main() -> None:
    ...
    log("React command center v2 enabled")
